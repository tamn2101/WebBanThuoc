...
namespace WebBanThuoc.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            ViewBag.ProductCategory = new SelectList(db.ProductCategories.ToList(), "Id", "Ten");
            return View();
        }
        ...
        public ActionResult Add(Product model, List<string> Images, List<int> rDefault)
        {
            if (ModelState.IsValid)
            {
                ...
                if (string.IsNullOrEmpty(model.SeoTen))
                {
                    model.SeoTen = model.Ten;
                }
                if (string.IsNullOrEmpty(model.KiHieu))
